...
if ( ! class_exists('GM_Template') ) :
    ...
    class GM_Template {
        ...
        public function __construct() {
            ...
            // Templates array.
            self::$templates = array(
                'template_add_table.php' => esc_html__( 'Game Management add table', 'template_add_table' ),
                'template_programme.php' => esc_html__( 'Game Management programme', 'template_programme' ),
            );
        }
        ...
        public function display( $template ) {
            ...
            $template_path = 'game_management/';
            $default_path  = TTRPG_GAME_TEMPLATE_PATH ;
